	...
	<?php if($form_name == 'slider-add' || $form_name == 'slider-edit'){
		...
		<?php } ?>
				...
				<fieldset>
					...
					<input type="submit" value="<?php if($form_name == 'slider-edit'){ echo 'Edit'; }else{ echo 'Add'; }?>">
				</fieldset>
			</form>
	<?php } ?>
	...
	<?php if($form_name == 'about-add' || $form_name == 'about-edit'){
		...
		<?php } ?>
				...
				<fieldset>
					...
					<input type="submit" value="<?php if($form_name == 'about-edit'){ echo 'Edit'; }else{ echo 'Add'; }?>">
				</fieldset>
			</form>
	...
	<?php if($form_name == 'team-add' || $form_name == 'team-edit'){
		...
		<?php } ?>
				...
				<fieldset>
					...
					<input type="submit" value="<?php if($form_name == 'team-edit'){ echo 'Edit'; }else{ echo 'Add'; }?>">
				</fieldset>
			</form>
	...
	<?php if($form_name == 'process-add' || $form_name == 'process-edit'){
		...
		<?php } ?>
				...
				<fieldset>
					...
					<input type="submit" value="<?php if($form_name == 'process-edit'){ echo 'Edit'; }else{ echo 'Add'; }?>">
				</fieldset>
			</form>
	...
	<?php if($form_name == 'cat-add' || $form_name == 'cat-edit'){
		...
		<?php } ?>
				...
				<fieldset>
					...
					<input type="submit" value="<?php if($form_name == 'cat-edit'){ echo 'Edit'; }else{ echo 'Add'; }?>">
				</fieldset>
			</form>
	<?php } ?>
	...
	<?php if($form_name == 'prod-add' || $form_name == 'prod-edit'){
		...
		<?php } ?>
				...
				<fieldset>
					...
					<input type="submit" value="<?php if($form_name == 'prod-edit'){ echo 'Edit'; }else{ echo 'Add'; }?>">
				</fieldset>
			</form>
	<?php } ?>
	...
	<?php if($form_name == 'certification-add' || $form_name == 'certification-edit'){
		...
		<?php } ?>
				...
				<fieldset>
					...
					<input type="submit" value="<?php if($form_name == 'certification-edit'){ echo 'Edit'; }else{ echo 'Add'; }?>">
				</fieldset>
			</form>
	<?php } ?>
	...
	<?php if($form_name == 'contact-add' || $form_name == 'contact-edit'){
		...
		<?php } ?>
				...
				<fieldset>
					...
					<input type="submit" value="<?php if($form_name == 'contact-edit'){ echo 'Edit'; }else{ echo 'Add'; }?>">
				</fieldset>
			</form>
	<?php } ?>
	...
	<?php if($form_name == 'special-add' || $form_name == 'special-edit'){
		...
		<?php } ?>
				...
				<fieldset>
					...
					<input type="submit" value="<?php if($form_name == 'special-edit'){ echo 'Edit'; }else{ echo 'Add'; }?>">
				</fieldset>
			</form>
	<?php } ?>
