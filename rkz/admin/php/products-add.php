...
if($uploadImage['status'] == 'false'){
	...
	$query = mysql_query("INSERT INTO prod (title, article, featured, description, url, cat_id, sub_cat_id) VALUES ('$title', '$article', '$feat', '$prod_desc', '$url_img', '$cat_id', '$sub_cat_id')");
	if($query){
		echo '0';
	}else{
